...
const Contact = () => {
  return (
    <section id='contact'>
      <h2 className='contact-head animate__animated animate__fadeInLeft'>
        Interested in working together, or connecting with me?
      </h2>
      <div className='social-media animate__animated animate__fadeInDown'>
